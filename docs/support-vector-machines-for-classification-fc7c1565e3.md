...
嗯，从微积分我们知道，为了找到最大值，我们需要使用导数。在这种情况下，我们使用不涉及对等术语的表达会更方便。那么，我们怎样才能使 d*d*方程更容易优化呢？是的，你猜对了！将括号内的倒数项倒置，然后将其转化为最小化问题。让我们这样做:
...
![](img/fa29dc12506332beb3e2de6e959cb621.png)![](img/a830947051b8ba5464fc8c8b1eb4c25c.png)
