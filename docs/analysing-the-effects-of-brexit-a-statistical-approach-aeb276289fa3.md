...
![](img/f2b37807e146ce58fe46bc1677a9ea19.png)

Photo by [Habib Ayoade](https://unsplash.com/@thedolapo?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)
...
![](img/b409858ed20152ab2205f2e3749cee89.png)
...
> OHLC 图是一种条形图，显示每个时期的开盘价、最高价、最低价和收盘价。OHLC 图表很有用，因为它们显示了一段时间内的四个主要数据点，收盘价被许多交易者认为是最重要的。— [投资媒体](https://www.investopedia.com/terms/o/ohlcchart.asp)

此外，在 OHLC 图表的顶部，还绘制了各种其他统计图表，如*布林线(BB)、移动平均线收敛背离(MACD)、变化率(ROC)、随机动量指数(SMI)、相对强弱指数(RSI)、商品通道指数(CCI)、*和*止损反转(SAR)* 。这些图表都提供了对特定时间序列所遵循的趋势的统计洞察。不用说，这些统计工具在金融交易和投资领域被广泛采用。

![](img/bf19c041337aa276f2b2dda907725bd9.png)![](img/287c62ceaa679376767efbce7ca046f7.png)![](img/7b598f374d94a2ad9028ac9cf3d0aaaf.png)![](img/66dbd6155e1ddd3e3cae5b376bb89606.png)
...
![](img/01e3eb375afc30f74e13ec245a0f5efe.png)
...
![](img/2a7e1ff5259011a9a7741d38f6ac861f.png)
...
为了有效地确定构建风险评估的最佳模型，我们必须首先检查**正态性、独立性和统计平稳性**。

![](img/9e10dfa3f6a35f79b3992b56a08baa67.png)
...
![](img/e77e8cf098d6c688ae33b843807a9e0e.png)![](img/8efd20220a657380f4caae51c4108e02.png)![](img/3fb923c6fe831ebb1ccb7de47404a429.png)![](img/d403d8e71c663405cbb5c4ebb66862fe.png)
...
![](img/0bf8fc2820ff4f70f41e348b5a534a7b.png)
...
![](img/59821ee7fe9031612ca652834f0e553e.png)

此外，如侧图所示，绘制了自相关函数(ACF)和偏自相关函数(PACF)、Q-Q 图和标准化残差的经验密度，以进一步总结拟合模型。使用拟合的 GARCH 模型，绘制了对数收益波动率，如下所示。

![](img/64fd033611dac3b9d9fadd68ba873617.png)![](img/bdc00239c8849a5e56c8a573c08da5a8.png)
...
![](img/d14bf9ac24cfd4c08d8913053e87bce9.png)
...
![](img/5be0ce4f2af8d8146645b71f7ee36993.png)![](img/6061f6673c1185d94417bc1945acf042.png)![](img/06d71867839135f76aa8e162999823d4.png)![](img/285379d93ce08c8cb611a28732a10c88.png)
...
这个项目的更多信息和完整源代码可以在这个 [GitHub 资源库](https://github.com/davidfarrugia/Brexit-Statistical-Analysis)中找到。
